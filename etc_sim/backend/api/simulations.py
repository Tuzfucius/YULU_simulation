...
async def list_simulations(
    ...
    for simulation_id, simulation in _simulations_db.items():
        if status_filter and simulation.get("status") != status_filter:
            continue
        simulations.append(
            {
                "id": simulation_id,
                "status": simulation.get("status", "pending"),
...
async def get_simulation_results(simulation_id: str) -> dict:
    ...
    simulation = _simulations_db[simulation_id]
